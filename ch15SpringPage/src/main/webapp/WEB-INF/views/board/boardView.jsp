...
<div class="page-main">
	...
	<div>
		<%-- 좋아요 --%>
		<img id="output_fav" data-num="${board.board_num}" src="${pageContext.request.contextPath}/images/fav01.gif"><!-- js에서는 el로 직접 호출할 수 없기 때문에 태그에 board_num을 넣어놨다. -->
	...
	<div class="align-right">
		<c:if test="${!empty user && user.mem_num == board.mem_num}"><%-- 로그인이 되었는지 확인 + 작성자와 로그인한 사람이 같은지 --%>
