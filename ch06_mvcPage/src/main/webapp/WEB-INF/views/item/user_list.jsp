	...
	<div class="content-main">
		...
		<c:if test="${count > 0}">
			<div class="item-space">
				...
				<div class="horizontal-area"> <%--가로로 디스플레이 되어 있는 걸 세로로 보여지게 하기 위해서 클래스에 horizontal-area를 넣음 --%>
				...
				<div class="align-center float-clear">${page}</div> <%--나머지는 float를 넣을 건데 여기는 float 효과를 주지 않기 위해서 클래스에 float-clear를 넣음 --%>
			</div>
		</c:if>
	</div>
</div>
