...
<div class="page-main">
	...
	<div class="content-main">
		<h2>상품 등록</h2>														<!-- 파일 업로드하는 부분이 있기 때문에 반드시 enctype명시 -->
		<form id="write_form" action="adminWrite.do" method="post" enctype="multipart/form-data">
			<ul>
				...
				<li>
					...
					<input type="file" name="photo1" class="input-check" id="photo1" accept="image/gif,image/png,image/jpeg">
				</li>
				<li>
					<label for="photo2">상품사진2</label>
					<input type="file" name="photo2" class="input-check" id="photo2" accept="image/gif,image/png,image/jpeg">
				</li>
				<li>
