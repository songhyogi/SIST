		...
		<form id="cart_order" action="${pageContext.request.contextPath}/order/orderForm.do" method="post">
			<table>
				...
				<tr>
					...
					<%-- status가 2->1로 바뀜 장바구니에 담을 때는 판매중이었는데 구매하려고 했더니 판매 중지되는 경우가 있다. --%>
						...
						<br>
						<input type="button" value="변경" class="cart-modify" data-cartnum="${cart.cart_num}" data-itemnum="${cart.item_num}"><%-- 이벤트가 발생한 곳에서 정보를 얻어내려고 커스텀데이터속성을 사용 --%>
						</c:if>
					</td>
					<td class="align-center">
