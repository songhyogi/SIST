...
<div class="page-main">
	...
	<div class="content-main">
		...
		<div class="result-display">
			배송대기일 때만 배송지 정보를 수정할 수 있습니다.
		</div>
		</c:if>
		<c:if test="${order.status == 1}"> <%-- order.status가 1일때만 form이 보여지게 --%>
			<form action="modify.do" method="post" id="order_modify">
				...
				<ul>
					...
					<li>
						<label for="zipcode">우편번호</label><!-- input태그의 id와 label의 for가 동일해야한다. -->
						<input type="text" name="receive_post" value="${order.receive_post}" id="zipcode" maxlength="10">
